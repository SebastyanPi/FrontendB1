                    ...
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="" method="post" id="formRegister">
                                ...
                                <hr>
                                <div class="form-group text-center">
                                    <b><label>Formulario de registro</label></b> 
                                </div>
                                <div class="form-group">
                                    <label>Nombre</label>
                                    <input class="au-input au-input--full" type="text" name="name" id="name_form" >
                                    <small class="text-danger d-none" id="name_alert"><i class="fa fa-warning"></i> El campo Nombre está vacio.</small>
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                                    <input class="au-input au-input--full" type="email" name="email" id="email_form" >
                                    <small class="text-danger d-none" id="email_alert"><i class="fa fa-warning"></i> El campo Email está vacio.</small>
                                </div>
                                <div class="form-group">
                                    <label>Contraseña</label>
                                    <input class="au-input au-input--full" type="password" name="password" id="password_form" >
                                    <small class="text-danger d-none" id="password_alert"><i class="fa fa-warning"></i> El campo Contraseña está vacio.</small>
                                </div>
             
                                <button class="au-btn au-btn--block au-btn--green m-b-20 redondeado" type="submit">Registrar</button>

                                <div class="text-right text-blue">
                                    <a href="login.php"><small><i class="fa fa-share"></i> Iniciar Sesión</small></a>
                                </div>
                            </form>
                        </div>
                    </div>
